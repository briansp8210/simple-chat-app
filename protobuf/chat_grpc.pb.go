...
func (c *chatClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedChatServer) Login(context.Context, *LoginRequest) (*Empty, error) {
